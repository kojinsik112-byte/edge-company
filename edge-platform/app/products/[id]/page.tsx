      ...
      {related.length > 0 && (
        <section className="mt-14">
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            {related.map((r) => (
              <Link key={r.id} href={`/products/${r.id}`} className="group overflow-hidden rounded-2xl border border-line bg-surface transition hover:-translate-y-1 hover:shadow-[0_22px_45px_-24px_rgba(47,37,28,0.25)]">
