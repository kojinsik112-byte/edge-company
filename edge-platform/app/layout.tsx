...
export const metadata: Metadata = {
  ...
  title: {
    default: "울산 부산 포항 경주 실링팬 간접조명 스마트조명 전문 | 엣지컴퍼니",
    template: "%s | 엣지컴퍼니",
  },
  description:
    "엣지컴퍼니는 울산·부산·포항·경주 지역 실링팬, 간접조명, 스마트조명, 전기공사를 전문으로 시공하는 프리미엄 조명 쇼룸입니다.",
  keywords: [
    "울산 실링팬", "부산 실링팬", "포항 실링팬", "경주 실링팬",
    "울산 간접조명", "부산 간접조명", "포항 간접조명", "경주 간접조명",
    "울산 조명 쇼룸", "부산 조명 시공", "포항 조명 시공", "경주 조명 시공",
    "아크로 실링팬", "ACRO 실링팬", "스마트조명", "우물천장 간접조명",
  ],
  ...
  openGraph: {
    ...
    locale: "ko_KR",
    siteName: "엣지컴퍼니",
    title: "울산·부산·포항·경주 실링팬·간접조명·스마트조명 전문 쇼룸 | 엣지컴퍼니",
