    ...
    <section className={`${bg} py-16 md:py-24`}>
      <div className="reveal mx-auto max-w-[1320px] px-6">
        <div className="mb-10 flex items-end justify-between gap-4">
          <div>
            <h2 className="text-[26px] font-display font-extrabold leading-snug text-ink md:text-[32px]">{title}</h2>
        ...
        <div className="grid grid-cols-2 gap-5 md:gap-6">
          {showDemo
            ? demoTiles(6).map((t, i) => (
                <div key={i} className="group relative aspect-[4/3] overflow-hidden rounded-2xl bg-surface shadow-[0_10px_30px_-18px_rgba(47,37,28,0.2)]">
