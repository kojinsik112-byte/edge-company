  ...
  return (
    <div className="mx-auto max-w-[1180px] px-5 py-12 md:py-16">
      ...
      <p className="mt-4 max-w-2xl text-[15px] leading-relaxed text-muted">
        {CATEGORY_DESC[category]} 엣지리브커튼 울산본점은 {region}을 포함한 울산·양산·부산·경주 전 지역에서 {category} 실측·시공을 직접 진행합니다.
      </p>

      <div className="mt-6 flex flex-wrap gap-2">
        <a href={`tel:${site.phone.replace(/-/g, "")}`} className="rounded-lg bg-ink px-5 py-3 text-[14px] font-semibold text-white transition hover:bg-[#161b15]">
