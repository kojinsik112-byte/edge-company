          ...
          {channels.map((c) => {
            ...
            return (
              ...
              >
                ...
                {live ? (
                  <span className="mt-5 inline-flex items-center justify-center gap-1.5 rounded-lg border border-line bg-white py-3 text-[14px] font-bold text-ink transition group-hover:border-transparent group-hover:bg-[#e6cdbb]">
