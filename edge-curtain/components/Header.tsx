    ...
    <>
      ...
      <header className="sticky top-0 z-50 border-b border-line bg-surface">
        <div className="mx-auto flex h-[72px] max-w-[1320px] items-center justify-between px-6">
          {/* 로고 */}
          <Link href="/" className="flex shrink-0 items-center gap-3.5" aria-label="엣지리브커튼 홈">
            ...
            <span className="leading-none">
              <span className="block text-[20px] font-extrabold tracking-tight text-ink">엣지리브커튼 <span className="text-[14px] font-bold text-gold-d">울산본점</span></span>
