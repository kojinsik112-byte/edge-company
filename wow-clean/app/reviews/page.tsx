...
export const metadata: Metadata = {
  title: "고객 후기 — 전국 하수구막힘·변기막힘·배관청소",
  description: "와우클린 하수구막힘·변기막힘·배관청소 시공 고객 후기. 실제 시공 만족도를 확인하세요.",
          ...
          {reviews.map((r) => (
            <div key={r.id} className="overflow-hidden rounded-2xl border border-line bg-surface">
              ...
              <div className="p-6">
                ...
                <p className={`${r.title ? "mt-1.5" : "mt-3"} text-[15px] leading-relaxed text-muted`}>“{r.content}”</p>
