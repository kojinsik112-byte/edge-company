...
export default async function AdminDashboard() {
  ...
  const cards = [
    { href: "/admin/settings", title: "사이트 설정", desc: "배너·회사·시공현장·사업자등록증·출동지역·협력사·카테고리·공지바·SEO", badge: "" },
    { href: "/admin/cases", title: "시공사례", desc: "등록·수정·삭제", badge: `${cases}건` },
    { href: "/admin/products", title: "서비스 안내", desc: "하수구막힘·변기막힘·배관청소 등", badge: `${products}건` },
  ...
  return (
    <div className="mx-auto max-w-[1000px] px-5 py-8">
      <header className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-xl font-extrabold text-ink">와우클린 관리자</h1>
