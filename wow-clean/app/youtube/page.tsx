...
export const metadata: Metadata = {
  title: "시공 영상 (유튜브) — 하수구 뚫음·배관청소",
  description: "와우클린 하수구막힘·변기막힘·배관청소 시공 영상 모음.",
...
export default async function YoutubePage() {
  ...
  return (
    <div className="mx-auto max-w-[1320px] px-6 py-12 md:py-16">
      ...
      <p className="mt-3 text-[14.5px] text-muted">하수구 뚫음·배관청소 시공 과정을 영상으로 확인하세요. 썸네일을 누르면 바로 재생됩니다.</p>
