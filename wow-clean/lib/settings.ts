...
export const DEFAULT_SETTINGS: Settings = {
  ...
  seo: {
    home: {
      ...
      description:
        "와우클린은 하수구 막힘 뚫음, 변기막힘, 고압 배관청소, 누수탐지를 전문으로 하는 전국 24시간 출동 시공 기업입니다. 시공 전 투명 견적, 작업 후 A/S 보증. 대표번호 1668-8982.",
  ...
  branches: {
    ...
    rows: [
      { name: "서울", area: "서울 전역", phone: "1668-8982" },
      { name: "경기 · 인천", area: "경기 전역 · 인천", phone: "1668-8982" },
      { name: "부산 · 경남", area: "부산 · 울산 · 창원 · 김해", phone: "1668-8982" },
      { name: "대구 · 경북", area: "대구 · 포항 · 구미 · 경주", phone: "1668-8982" },
      { name: "대전 · 충청", area: "대전 · 세종 · 천안 · 청주", phone: "1668-8982" },
      { name: "광주 · 전라", area: "광주 · 전주 · 목포 · 여수", phone: "1668-8982" },
    ],
    mapImage: "",
  },
  partners: {
