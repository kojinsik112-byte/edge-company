...
// 와우클린 전국 출동 지역 — 표 + 지도 이미지(이미지+텍스트), 관리자에서 편집
        ...
        <div className="space-y-6">
          {branches.mapImage && (
            <div className="relative aspect-[2/1] overflow-hidden rounded-2xl border border-line bg-bg">
              <Image src={branches.mapImage} alt="와우클린 전국 출동 지역 지도" fill sizes="(max-width:1080px) 100vw, 1080px" className="object-contain" />
            </div>
          )}
          {rows.length > 0 && (
