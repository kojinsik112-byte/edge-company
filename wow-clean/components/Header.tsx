    ...
    <>
      ...
      <header className="sticky top-0 z-50 border-b border-line bg-surface">
        <div className="mx-auto flex h-[72px] max-w-[1320px] items-center justify-between px-6">
          {/* 로고 */}
          <Link href="/" className="flex shrink-0 items-center gap-3.5" aria-label="와우클린 홈">
            <span className="font-lux flex h-[44px] w-[44px] items-center justify-center rounded-[9px] bg-navy text-[25px] font-semibold text-white">
              W
            </span>
            <span className="leading-none">
              <span className="block text-[22px] font-extrabold tracking-tight text-ink">와우클린</span>
